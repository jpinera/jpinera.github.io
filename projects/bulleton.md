...
Since this was the first time I was able to work on a fully-functional app that had meaningful impact, working on this project has also helped me learn how to develop some of the intangible soft skills that occur within a team. Communication is obviously a significant component in group work and a main takeaway from this experience. However, I learned that seeking help, as well as seeking to help others when they are struggling on their tasks, is just as important. These are some the skills that I intend to work on to establish a cohesive, safe, and effective work environment with my other project peers.

After going through the entire process, such as planning, designing, programming, testing, and implementing the code, I realized that constant incremental changes in small portions are required to improve the quality of an app.  I also learned that planning is an important key portion of the design process because careful planning minimize major issues in the long run. The opposite can result in serious ramifications in a domino effect of errors. Using Issue Driven Project Management (IDPM) made it easier to break down issues into manageable chunks, which allowed our team to keep a better track of our progress through consistent milestone deadlines. Overall, I intend to utilize this effective technique of project management in my future projects and other software engineering practices. 
