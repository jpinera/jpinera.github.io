...
Since this was the first time I was able to work on a fully-functional app that had meaningful impact, working on this project has also helped me learn how to develop some of the intangible soft skills that occur within a team. Communication is obviously a significant component in group work and a main takeaway from this experience. However, after going through the entire process, such as planning, designing, programming, testing, and implementing the code, I realized that constant incremental changes in small portions are required to improve the quality of an app.  

with a team intangible soft skills that I need to work on. important/key, cohesive
