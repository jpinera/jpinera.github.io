...
<img width="500px" class="rounded float-start pe-4" src="../img/technical-essays/414-reflection/team-bonding.jpg" alt="ui-1"> 
...
<img align="right"  class="rounded ps-4" width="500px"  src="../img/technical-essays/414-reflection/agile-workflow.jpg" alt="ui-4">
...
* Writing <span style='font-family: monospace; color: #3378d2ff;'> **unit/acceptance tests** </span> to debug edge cases in code from the backend/frontend sides
* Creating <span style='font-family: monospace; color: #3378d2ff;'> **GitHub boards** </span> for milestones
* Setting up <span style='font-family: monospace; color: #3378d2ff;'> **GitHub issues** </span> 
* Setting up <span style='font-family: monospace; color: #3378d2ff;'> **code reviews** </span> and adding comments for the files to review (in the code review)
* Assigning issues to specific boards for milestones and organizing them by <span style='font-family: monospace; color: #3378d2ff;'> **issue types** </span>  
  * (i.e. Code review issue or milestone issue)
* Updating our <span style='font-family: monospace; color: #3378d2ff;'> **organization home page** </span> for the project on a weekly basis
...
* <span style='color: #E685B5;'>**Double maintenance problem**</span> :
